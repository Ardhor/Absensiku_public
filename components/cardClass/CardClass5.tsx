...
type CardClass5Props = {
    class_name: string;
    description: string;
    admin: string;
}

const CardClass5: React.FC<CardClass5Props> = ({ class_name, description, admin }: any) => {
    return (
        <View>
            <TouchableOpacity
                activeOpacity={0.5}
            ...
            >
                <View
                    className='mt-[10] w-[100%] bg-[#566e79] px-[25] py-[15] justify-start items-start rounded-[15]'
                >
                    <Text
